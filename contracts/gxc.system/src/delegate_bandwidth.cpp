...
using eosio::asset; using eosio::indexed_by; using eosio::const_mem_fun; using eosio::print; using eosio::permission_level;
...
struct [[eosio::table, eosio::contract("gxc.system")]] user_resources {
   name          owner;
   asset         net_weight;
   asset         cpu_weight;
   int64_t       ram_bytes = 0;
 ...
 */
struct [[eosio::table, eosio::contract("gxc.system")]] delegated_bandwidth {
   name          from;
   name          to;
   asset         net_weight;
   asset         cpu_weight;
...
struct [[eosio::table, eosio::contract("gxc.system")]] refund_request {
   name            owner;
